...
- `GET /api/amazon/{integrationInstance}/awd/ledgers/departure-links` — List AWD Departure Attributions
- `DELETE /api/amazon/{integrationInstance}/awd/ledgers/departure-links/{awdLedger}` — Remove AWD Departure Attribution
- `POST /api/amazon/{integrationInstance}/awd/ledgers/departure-links/{awdLedger}` — Attribute AWD Departure To Shipment
- `GET /api/amazon/{integrationInstance}/awd/ledgers/departure-unit-comparison` — Get AWD Departure Unit Comparison
...
- `GET /api/amazon/{integrationInstance}/awd/ledgers/unattributed-departures` — List Unattributed AWD Departures
